package com.fanyafeng.todomvp.network;
...
public class NetUtil {
    ...
    static {
        mOkHttpClient = new OkHttpClient.Builder().connectTimeout(30, TimeUnit.SECONDS).readTimeout(30, TimeUnit.SECONDS).writeTimeout(30, TimeUnit.SECONDS).build();
//        mOkHttpClient.connectTimeoutMillis().setConnectTimeout();
    ...
    public static String httpPostUtil(Context context, String url, Map<String, String> params) {
        ...
        setTokenHeader(requestBuilder, null, url, "3");
